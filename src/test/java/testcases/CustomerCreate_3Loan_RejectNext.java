...
public class CustomerCreate_3Loan_RejectNext {
	
	@Test(priority=1,dataProvider="customerloan3andreject",dataProviderClass=CustomerLoan3RejectNextDataProvider.class)
	public void createCustomer(String email,String password,String ssnvalue,String homephonevalue,String lastname,String zip,String dob,String question1,String question2,String loanoption1,String loanoption2,String loanoption3,String routno,String acctno1,String ename,String add,String city,String state,String browserType) throws Exception
	{
	...
	@Test(priority=2,dataProvider="customerloan3andreject",dataProviderClass=CustomerLoan3RejectNextDataProvider.class)  
	...
	@Test(priority=3,dataProvider="customerloan3andreject",dataProviderClass=CustomerLoan3RejectNextDataProvider.class)  
	...
	@Test(priority=3,dataProvider="customerloan3andreject",dataProviderClass=CustomerLoan3RejectNextDataProvider.class)  
	public void CompleteLoan3(String email,String password,String ssnvalue,String homephonevalue,String lastname,String zip,String dob,String question1,String question2,String loanoption1,String loanoption2,String loanoption3,String routno,String acctno1,String ename,String add,String city,String state,String browserType) throws Exception
	{
		ELSLoginPageObject lpo=new ELSLoginPageObject(browserType);
		TestUtil.elslogin(email, password, lpo);	
		Reporter.log("Customer tries to take a Loan of : "+loanoption3);
		...
		//---enter application info---enter ssn	and home phone,city,state and address
		AppInfoPageObject ai2 =TestUtil.appInfowithEmpData(ssnvalue, homephonevalue,add,city,state, rd);
		String loan3=TestUtil.loanprocess(loanoption1, routno, acctno1,ename, ai2);
		
		System.out.println(loan3);
		if (loan3.isEmpty()==false)
		{
			Reporter.log("Third Loan process is successful and loan number is: "+loan3);
		}
		else
		{
			Reporter.log("Third Loan process is not successful.");
		}
		Assert.assertEquals(loan3.isEmpty(),false);
	}
		
	@Test(priority=4,dataProvider="customerloan3andreject",dataProviderClass=CustomerLoan3RejectNextDataProvider.class)
