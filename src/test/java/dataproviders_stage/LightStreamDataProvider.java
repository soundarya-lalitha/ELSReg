...
public class LightStreamDataProvider {
	static Logger log = Logger.getLogger(LightStreamDataProvider.class);

	@DataProvider(name = "Light")
	public static Object[][] getTermiCustomerData() throws Exception {
		log.info("starting to get LargeDollar data");
		
		String sheetName = "Credit_LightStream_Flow";
		...
		log.info("exiting the Large Dollar data provider method");
		return obj;
