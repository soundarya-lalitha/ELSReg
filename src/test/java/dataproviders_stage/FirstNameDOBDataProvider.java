...
public class FirstNameDOBDataProvider {
	static Logger log = Logger.getLogger(FirstNameDOBDataProvider.class);

	@DataProvider(name = "DOB")
	public static Object[][] getHRData() throws Exception {
		log.info("starting to get DOB data");
		String sheetName = "FnameInDOB";
		...
		log.info("exiting the DOB data provider method");
		return obj;
	}	
