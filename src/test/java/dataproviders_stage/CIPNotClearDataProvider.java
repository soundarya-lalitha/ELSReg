...
public class CIPNotClearDataProvider {
	static Logger log = Logger.getLogger(CIPNotClearDataProvider.class);

	@DataProvider(name = "cipnotclear")
	public static Object[][] getTermiCustomerData() throws Exception {
		log.info("starting to get cipclear data");
		
		String sheetName = "CIP_Not_Clear";
