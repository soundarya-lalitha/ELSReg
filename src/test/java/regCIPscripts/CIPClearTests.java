...
import dataproviders_stage.PositiveCIPDataProvider;
import pageobjects.AppInfoPageObject;


import testcases.util.TestUtil;

public class CIPClearTests {

	@Test(dataProvider="cipclear",dataProviderClass=PositiveCIPDataProvider.class)
	public void CIPClear(String email,String password,String ssn,String homephone,String workEmail,String address,String city,String state,String workstate,String cipadminEmail,String cipadminPassword,String path,String employer,String cipaction,String ssn2, String loanamt,String routno,String acntno,String accType,String ename,String userType1,String userType2,String browserType) throws Exception
	{
		...
		System.out.println("CIP Failure: "+result1);
		...
		else
		{
			...
			TestUtil.customerApplyAgain(email, password,cipaction, homephone, address, city, state,workstate, ssn2,workEmail,loanamt, routno, acntno, accType,ename,userType1,browserType, loanNumber);
