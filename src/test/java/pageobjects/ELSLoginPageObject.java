...
public class ELSLoginPageObject {
  ...
  //field variAbles to interact with ui
	 ...
	 * @throws IOException 
	 */
  public ELSLoginPageObject(String browserType,String userType) throws Exception {
  ...
  String file=ClassLoader.getSystemResource("common.properties").getFile();
