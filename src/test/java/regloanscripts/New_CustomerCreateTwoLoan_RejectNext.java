...
//
//public class New_CustomerCreateTwoLoan_RejectNext {
...
//				AppInfoPageObject ai2 =TestUtil.appInfoFlowwithEmpData1(ssnvalue, homephonevalue,add,city,state,workstate, lpoloan);
...
//					AppInfoPageObject ai3 = TestUtil.appInfoFlowwithEmpData2(ssnvalue, homephonevalue,add,city,state,workstate, lc);
...
//						//---enter application info---enter ssn	and home phone
//						AppInfoPageObject ai4 = TestUtil.appInfoFlowwithEmpData2(ssnvalue, homephonevalue,add,city,state,workstate, lc);
