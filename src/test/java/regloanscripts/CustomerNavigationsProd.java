...
import dataproviders.CustNavigationProdDataProvider;
...
public class CustomerNavigationsProd {
		
	@Test(dataProvider="customernavigation",dataProviderClass=CustNavigationProdDataProvider.class)  
